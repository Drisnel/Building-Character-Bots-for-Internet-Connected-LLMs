...
Le modèle n’a pas besoin d’aide pour comprendre un canon.
...
- quels archétypes génériques le modèle risque d’imposer si le script est trop vague
...
Le but est de créer un cadre jouable qui donne au modèle suffisamment de structure pour produire un bot de roleplay stable sur la durée.

---

## 1. Commencer par le pitch

Pour les personnages originaux, je ne commence pas par les traits de personnalité.

Je commence par le pitch.

Le pitch est le cœur du bot.
...
Il me dit quel type d’histoire ce bot est construit pour générer.

Au minimum, je veux que le pitch établisse :

- qui est le personnage
- dans quel type d’univers il vit
- quelle pression définit sa vie
- quel rôle ou quelle fonction il occupe dans cet univers
- qui est l’utilisateur par rapport à lui
- ce qui met la relation en mouvement
- quel type de dynamique le bot est censé créer

Je ne veux pas un concept vague.
...
- « C’est un mercenaire charmeur qui cache un côté tendre. »
- « C’est une princesse qui veut être libre. »

Pris seuls, ces éléments ne sont pas exploitables.

Ils décrivent une ambiance.

Ils ne définissent pas encore un moteur narratif.

### Un pitch plus solide répond généralement à des questions comme celles-ci

- Que fait réellement ce personnage ?
- Quelle pression définit sa situation actuelle ?
- Que veut-il, maintenant ?
- Que refuse-t-il ?
- De quoi est-il responsable ?
- Qu’est-ce qu’il est incapable d’ignorer ?
- Pourquoi l’utilisateur compte-t-il dans cette configuration ?
- Pourquoi la relation ne peut-elle pas rester neutre ?
- Quel type de scènes cette prémisse est-elle censée produire naturellement ?
- Quel type de progression le bot est-il censé générer au fil du temps ?

Si je ne peux pas répondre à ces questions, le pitch n’est généralement pas prêt.

---

## 2. Construire l’univers comme un système jouable

Pour les personnages originaux, l’univers compte davantage que pour les bots canons.

En revanche, je ne traite pas le worldbuilding comme une encyclopédie.

Le modèle n’a pas besoin d’un wiki.

Il n’a pas besoin de chaque détail historique.
...
Je m’intéresse aux règles, aux pressions et aux structures de l’univers.

Je ne tiens pas à inclure chaque fait que j’ai inventé si ce fait ne change rien au roleplay.

### En général, je veux savoir :

- quel type d’univers c’est
- quel type de pouvoir y existe
- ce qui est socialement normal
- ce qui est socialement dangereux
- ce qui est interdit
- ce qui crée du statut
- ce qui crée de la vulnérabilité
- ce qui crée de la dépendance
- ce qui crée de la sécurité
- ce qui crée du risque
- ce qui crée de l’obligation
- ce qui crée de l’isolement
- ce qui crée de l’intimité
- ce qui rend les relations faciles, difficiles, coûteuses, dangereuses ou politiquement importantes
...
Le worldbuilding ne doit pas être décoratif.

Il doit façonner l’action, le risque et la logique relationnelle.
...
- quel rôle le personnage occupe dans l’univers
- sous quelle pression il vit
- quelle contradiction le définit
- pour quoi il est récompensé
- pour quoi il est puni
...
### Je préfère des questions comme :

- Comment ce personnage réagit-il sous pression ?
- Comment gère-t-il l’incertitude ?
- Quel type de problème résout-il directement ?
- Quel type de problème évite-t-il ?
- Comment exprime-t-il le contrôle ?
- Comment exprime-t-il la peur ?
- Comment exprime-t-il l’attachement ?
- Comment se comporte-t-il différemment une fois que l’utilisateur compte pour lui ?
- Que fait-il quand il se sent piégé ?
- Que fait-il quand il se sent responsable ?
- Que fait-il quand il se sent choisi ?
- Que fait-il quand il se sent menacé ?

Plus je comprends précisément la logique comportementale du personnage, plus le bot devient stable.

---

## 4. Définir le moteur de l’histoire, pas seulement le personnage

Un personnage original ne suffit pas.
...
- quel type de scènes cette prémisse doit générer
...
Il peut être agréable à lire.

Il peut même sembler cohérent.

Mais il ne produira pas un roleplay solide.

### J’ai souvent tendance à penser en termes de pression + relation + mouvement
...
Le moteur narratif doit me dire ce qui maintient le bot vivant sur le long terme.

---

## 5. Définir la place de l’utilisateur dans l’histoire

Pour les bots originaux, je n’aime pas laisser la place de l’utilisateur vague.
...
- Qui est l’utilisateur par rapport au personnage ?
- Pourquoi gravitent-ils l’un autour de l’autre ?
- Qu’est-ce qui les force à être en contact ?
- Qu’est-ce qui est déjà établi ?
- Qu’est-ce qui ne l’est pas ?
- Quel type de progression est prévu ?
- Qu’est-ce qui ne doit pas arriver automatiquement ?
- Quel type de tension, de confiance, de dépendance ou de conflit est intégré au setup ?

### Exemples

- conjoint fraîchement marié par arrangement
- personne protégée assignée à un garde du corps
- cohabitation imposée par nécessité administrative ou pratique
...
Elle doit produire de l’interaction immédiatement.

Elle ne doit pas simplement fournir du backstory.
...
Cette dérive peut être tout aussi destructrice.

Si le script est trop vague, le modèle remplacera souvent le personnage prévu par un modèle plus familier.
...
- le personnage joueur qui devient incapable de profondeur émotionnelle
- le personnage solitaire qui reste définitivement évitant
...
Si je sais en quoi le modèle risque de transformer le personnage, je peux le contrer directement.
...
Je veux transformer les traits en logique de décision.
...
Là, on obtient un comportement.

Autre exemple :

« réservé » est souvent trop vague.
...
## 8. Clarifier la logique interne du personnage avant d’écrire les modules

Avant de générer le script, je veux avoir une compréhension nette de la logique interne du personnage.

Toutes ces questions n’ont pas forcément la même importance pour chaque bot.

Mais j’aime avoir des réponses à la plupart d’entre elles.

### Questions que j’utilise souvent

- Que pense ce personnage de lui-même ?
- Que pense-t-il de l’attachement ?
- Que pense-t-il de la vulnérabilité ?
- Que pense-t-il de l’obligation ?
...
Mais je veux qu’elles soient claires avant de construire les modules.
...
Je ne crée des modules de continuité dédiés que lorsqu’un événement passé continue réellement à modifier le comportement actuel du personnage.

Ces modules ne sont pas des résumés de lore.

Ils servent à expliquer des conséquences comportementales.

### Exemples d’ancres de continuité pour un personnage original
...
Un lieu peut avoir une fonction narrative.

Il peut créer :

- de la routine
- de la proximité forcée
- de l’intimité
- de la surveillance
- de la domesticité
- de la hiérarchie
...
## 11. Définir une logique relationnelle, pas seulement un statut relationnel

Connaître le setup ne suffit pas.
...
- comment la confiance se construit
- comment l’attention change
- comment l’attachement devient visible
- ce qui pousse le personnage à rester
- ce qui le pousse à se retirer
- ce que le conflit fait à la relation
- ce que l’intimité change
- ce que la vulnérabilité change
- comment le personnage se comporte une fois que l’utilisateur compte pour lui

C’est l’un des endroits où j’utilise le plus la logique comportementale.

Je m’intéresse moins aux déclarations émotionnelles qu’aux conséquences comportementales.

### Je me pose souvent ce type de questions

- À quoi ressemble l’attachement chez ce personnage ?
- À quoi ressemble la jalousie ?
- À quoi ressemble la possessivité protectrice ?
- À quoi ressemble la peur de perdre quelqu’un ?
- Qu’est-ce qui change après l’intimité ?
- Qu’est-ce qui change après un conflit ?
- Qu’est-ce qui change après des excuses ?
- Qu’est-ce qui change une fois la confiance installée ?
- Qu’est-ce qui change après que le personnage a admis son désir, son amour ou sa dépendance émotionnelle ?

Si la réponse est « rien ne change », le bot finit généralement par stagner.

---

## 12. Convertir l’émotion en comportement

Je préfère presque toujours le comportement observable aux étiquettes émotionnelles.

Au lieu d’écrire :

il se sent attaché

je préfère écrire des comportements comme :
...
- s’impliquer plus directement
- réduire la distance plutôt que l’augmenter

La même logique s’applique aux autres états émotionnels.

### La peur peut devenir :

- du contrôle
- de la vigilance
- de l’évitement
- de l’irritation
- de la sur-préparation
- de la proximité
...
Le modèle est généralement plus cohérent avec des comportements qu’avec des déclarations émotionnelles abstraites.

---

## 13. Construire une logique de scène, pas seulement une logique de personnage

Un bot stable a besoin de plus qu’une personnalité et qu’un univers.

Il a aussi besoin d’une idée de la manière dont les scènes sont censées avancer.

C’est particulièrement important pour :

- les bots centrés sur la romance
- les slow burns
- les bots très conflictuels
- les bots orientés action
- les bots centrés sur l’intimité
- les scénarios de cohabitation ou de mariage
- toute histoire où la progression doit tenir sur la durée

Je veux généralement que le script puisse répondre à des questions comme :
...
## 14. Privilégier la guidance comportementale positive
...
La protection du joueur compte.
...
La guidance comportementale est générative.
...
## 15. Contrer les comportements prévisibles des LLM

Tous les problèmes ne viennent pas du concept du personnage.

Certains viennent du modèle lui-même.
...
## 16. Construire des systèmes anti-loop
...
Le joueur ne devrait pas avoir à résoudre plusieurs fois le même problème.
...
### Principes que j’utilise souvent
...
- un contrôle qui remplace l’intimité

Le but de l’anti-fallback n’est pas de sur-restreindre le script.

Le but est de bloquer la version incorrecte la plus prévisible du personnage.

---

## 18. Ajouter une protection du joueur

Chaque bot reçoit une protection du joueur.

Au minimum, je veux empêcher le modèle de s’approprier la perspective interne de l’utilisateur.
...
- écrire le dialogue de l’utilisateur
- narrer depuis le point de vue de l’utilisateur
- écrire à la première personne à la place de l’utilisateur
- définir les pensées de l’utilisateur comme des faits
- définir les émotions de l’utilisateur comme des faits
...
La ligne de séparation est simple :

- l’externe est autorisé
- l’interne est interdit
...
- le déplacement physique de l’utilisateur dans la scène
...
Tous les bots n’ont pas besoin des mêmes limites.

---

## 20. Générer le script

Une fois la phase d’analyse terminée, je passe à la génération du script.

À ce stade, je connais déjà :

- le pitch
- la logique de l’univers
- le rôle du personnage et sa contradiction centrale
- la prémisse relationnelle
- les dérives archétypales probables
- la logique comportementale
- les éventuelles ancres de continuité
- les éventuelles ancres environnementales
- les besoins anti-loop
- les besoins anti-fallback
- les protections du joueur
- les contrôles de portée narrative

J’utilise ensuite l’IA pour générer le script.

En général, je demande le script entier d’un seul bloc.

Si l’IA essaie de résumer certaines sections, de simplifier la structure ou de s’arrêter trop tôt, je continue jusqu’à ce que l’architecture complète soit produite.

Je ne demande pas une biographie.

Je ne demande pas des exemples de roleplay.

Je ne demande pas un texte de fiction.

Je demande un cadre comportemental conçu pour un LLM.

---

## 21. Utiliser un style d’écriture que le modèle peut récupérer facilement
...
convertir des concepts, des émotions et des traits en comportements observables que le modèle peut appliquer de manière cohérente.
...
## 22. Retirer les informations inutiles
...
Si une distorsion est particulièrement forte, répéter une idée importante à plusieurs endroits peut améliorer la stabilité.

En règle générale, la redondance est inefficace.

La redondance ciblée peut être utile.

La vraie question n’est pas :

Est-ce que ce détail est vrai ?
...
## 23. Réorganiser la priorité des modules

Une fois le script écrit, je réorganise souvent l’ordre des modules.
...
- quel type d’histoire ce bot raconte
- quelle place l’utilisateur occupe
- comment le personnage se comporte

Je place généralement plus bas les systèmes correctifs :

- anti-loop
- anti-fallback
- protection du joueur
- contrôles de portée narrative

Ces systèmes sont importants.

Mais je ne veux pas qu’ils remplacent le comportement central du personnage.

Je veux qu’ils corrigent les dérives, pas qu’ils deviennent le centre de gravité du bot.
...
- une dérive archétypale
- un problème de continuité
- un problème de rythme relationnel
...
Je m’attends à ce qu’il révèle ce qui doit encore être contraint.
