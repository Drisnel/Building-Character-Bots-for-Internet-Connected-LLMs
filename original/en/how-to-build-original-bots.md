# Original Character Workflow — How I Build Original Bots With AI

After building a large number of roleplay bots, I ended up developing a workflow that combines AI-assisted analysis, AI-assisted writing, and iterative testing.
...
- what kind of story this bot is meant to generate
- what kind of world this character exists in
- what kind of role the character occupies inside that world
- what kind of relationship dynamic the user is stepping into
- what kind of progression the bot is supposed to produce
- which generic archetypes the model is likely to impose if the script is too vague
...
The goal is to create a playable framework that gives the model enough structure to produce a stable roleplay bot over time.

---

## 1. Start With The Pitch

For original characters, I do not start with personality traits.

I start with the pitch.

The pitch is the core of the bot.

It is the point where the character, the world, the relationship dynamic, and the story engine meet.

If the pitch is weak, the bot usually becomes unstable no matter how much work is done later.

If the pitch is vague, the model will fill the gaps with generic archetypes, generic romance patterns, or generic roleplay logic.

A good pitch does not just say who the character is.

It tells me what kind of story this bot is built to generate.

At minimum, I want the pitch to establish:

- who the character is
- what kind of world they live in
- what kind of pressure defines their life
- what role or function they occupy in that world
- who the user is in relation to them
- what forces the relationship into motion
- what kind of dynamic the bot is supposed to create

I do not want a vague concept.

I want a playable premise.

### A weak pitch usually sounds like this

- "He is a cold mafia boss."
- "She is a powerful sorceress with a tragic past."
- "He is a flirtatious mercenary who secretly has a soft side."
- "She is a princess who wants freedom."

These are not usable by themselves.

They describe a vibe.

They do not yet define a story engine.

### A stronger pitch usually answers questions like these

- What does this character actually do?
- What pressure defines their current situation?
- What do they want right now?
- What do they refuse?
- What are they responsible for?
- What are they unable to ignore?
- Why does the user matter in this setup?
- Why can the relationship not remain neutral?
- What kind of scenes should naturally emerge from this premise?
- What kind of progression is the bot meant to produce over time?

If I cannot answer those questions, the pitch usually is not ready.

---

## 2. Build The World As A Playable System

For original characters, the world matters more than it usually does for canon bots.

However, I do not treat worldbuilding as an encyclopedia.

The model does not need a wiki.
...
- what kind of power exists in it
- what is socially normal
- what is socially dangerous
- what is forbidden
- what creates status
...
- what creates safety
- what creates risk
- what creates obligation
- what creates isolation
- what creates intimacy
- what makes relationships easy, difficult, costly, dangerous, or politically significant
...
If the setting contains magic, I do not stop at "magic exists."
...
- Can it expose secrets, bind people, heal people, mark people, track people, or ruin people?

Those answers matter because they change behavior.

Worldbuilding should not be decorative.

It should shape action, risk, and relationship logic.

---

## 3. Define The Character Through Function, Pressure, And Contradiction

For original characters, I care less about labels and more about function.

I want to know:

- what role the character occupies in the world
- what pressure they live under
...
- what changes once someone matters to them

I do not find labels like "cold," "soft," "reckless," or "guarded" very useful by themselves.

They need behavioral meaning.

### I prefer questions like:

- How does this character react under pressure?
- How do they handle uncertainty?
- What kind of problem do they solve directly?
- What kind of problem do they avoid?
- How do they express control?
- How do they express fear?
- How do they express attachment?
- How do they behave differently once the user matters?
- What do they do when they feel trapped?
- What do they do when they feel responsible?
- What do they do when they feel wanted?
- What do they do when they feel threatened?

The more precisely I understand the character's behavioral logic, the more stable the bot becomes.

---

## 4. Define The Story Engine, Not Just The Character

An original character is not enough.
...
The character profile tells me who this person is.

The story engine tells me what kind of movement the bot should naturally generate.

I want to know:

- what kind of scenes this premise should create
- what kind of conflict should keep appearing
- what kind of intimacy, tension, dependence, or rivalry should emerge
- what kind of progression the bot should be capable of sustaining over time
- what kind of rhythm the relationship should have

If the character exists but the story engine is weak, the bot often becomes static.
...
### I often think in terms of pressure + relationship + movement

For example:

- arranged marriage + political fragility + shared domestic space
- ex-partners forced back into cooperation + unresolved betrayal + mutual competence
- monster hunter + cursed user + dependency created by survival
- bodyguard + target + surveillance-heavy environment
- rival commanders + military alliance + private attraction neither can ignore
- healer + dangerous patient + secrecy that keeps forcing proximity

The story engine should tell me what keeps the bot alive over time.
...
- how attachment becomes visible
- what makes the character stay
- what makes the character retreat
- what conflict does to the relationship
- what intimacy changes
...
- What does attachment look like for this character?
- What does jealousy look like?
- What does protectiveness look like?
...
## 12. Convert Emotion Into Behavior

I almost always prefer observable behavior over emotional labels.
...
## 13. Build Scene Logic, Not Just Character Logic
...
- action-heavy bots
- intimacy-heavy bots
- cohabitation or marriage scenarios
- any story where progression matters over long conversations

I usually want the script to answer:

- What creates movement in a scene?
- What makes the character act instead of stalling?
- What kind of tension should be engaged rather than ignored?
- What kind of uncertainty should produce questions, and what kind should produce decisions?
- What does attachment change about pacing?
- What should happen after intimacy, conflict, vulnerability, or apology?
- When should the character initiate?
- When should the character confront?
- When should the character stop observing and act?

Without scene logic, a bot can know who the character is and still fail at roleplay.

It can stall, hesitate, repeat, or reset.
...
## 14. Prefer Positive Behavioral Guidance
...
- how they approach attachment
- how they behave once something matters

Restrictions are corrective.

Behavioral guidance is generative.
...
## 15. Counter Predictable LLM Behavior

Not every problem comes from the character concept.

Some problems come from the model itself.
...
If a model repeatedly makes the same mistake, I prefer correcting it explicitly rather than hoping it will stabilize on its own.

---

## 16. Build Anti-Loop Systems

Anti-loop modules are among the most important parts of my workflow.

The goal is not simply to reduce repetition.
...
- If wrong: acknowledge, adjust behavior, continue differently.
- Valid points remain valid.
- Resolved issues remain resolved.
- New information changes future behavior.
- If a pattern repeats, change behavior, pacing, decision, environment, perspective, proximity, or approach.
- Rephrasing does not reset progression.
...
- body language
- contextual physical responses
- physical displacement of the user within the scene
- guided scene progression
...
## 19. Add Narrative Scope Controls

Some major developments should never happen automatically.

This is true for canon bots and original bots alike.

I usually include explicit controls for things like:

- pregnancy
- children
- marriage if the story did not begin there
- major family expansion
- irreversible injuries if not intended
...
Not every bot needs the same ones.

---

## 20. Generate The Script

Once the analysis phase is complete, I move to script generation.

At that point, I already know:
...
- any continuity anchors
- any environmental anchors
...
I am not asking for a piece of fiction.

I am asking for a behavioral framework designed for an LLM.

---

## 21. Use A Writing Style The Model Can Retrieve

The writing style of the script matters.
...
## 22. Remove Unnecessary Information
...
- what role the user occupies
- how the character behaves

I usually place corrective systems later:
...
But I do not want them to replace the character's core behavior.

I want them to correct drift, not become the center of the bot.

---

## 24. Test And Apply Micro-Corrections

Testing is where most improvements happen.

Large rewrites are rare.

Most corrections are small.

I prefer targeted changes connected to specific observed problems.

### Examples

- one missing behavior
- one recurring loop
- one archetypal drift
- one continuity issue
- one relationship pacing problem
- one scene progression problem
- one missing world rule that the model keeps ignoring
...
For original characters, I am not only building a personality.
